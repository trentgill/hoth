...
/* package hoth-0.1.0.0 */
#define VERSION_hoth "0.1.0.0"
#define MIN_VERSION_hoth(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hoth-0.1.0.0-9kGQoXeTs5nH2901Kk1dfG"

#define CURRENT_PACKAGE_KEY "hoth-0.1.0.0-9kGQoXeTs5nH2901Kk1dfG"
